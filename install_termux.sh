...
echo "╠══════════════════════════════════════════════════════╣"
echo "║                                                      ║"
echo "║  Start AURA (terminal mode):                         ║"
echo "║    python launch/launcher.py                         ║"
echo "║                                                      ║"
echo "║  Open browser terminal (Chrome on S21):              ║"
echo "║    1. Start AURA:  python launch/launcher.py         ║"
echo "║    2. Inside AURA type:  web start                   ║"
echo "║    3. Open Chrome and go to:  http://localhost:7331  ║"
echo "║                                                      ║"
echo "║  System validation:                                  ║"
echo "║    python tools/validate_system.py                   ║"
echo "║                                                      ║"
echo "║  System info:                                        ║"
echo "║    python tools/aura_sys_info.py                     ║"
echo "║                                                      ║"
echo "║  Install a Python package:                           ║"
echo "║    Inside AURA type:  pkg install requests           ║"
echo "║                                                      ║"
echo "║  Run tests:                                          ║"
